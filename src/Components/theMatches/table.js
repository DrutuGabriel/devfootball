          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell numeric style={style.cell}>W</TableCell>
                <TableCell numeric style={style.cell}>D</TableCell>
                <TableCell numeric style={style.cell}>L</TableCell>
                <TableCell numeric style={style.cell}>Pts</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
